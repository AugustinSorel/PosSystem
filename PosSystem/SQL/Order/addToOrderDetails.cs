...
namespace PosSystem
{
    internal class AddToOrderDetails: SqlQueries
    {
        ...
        private OleDbCommand CreateCommand()
        {
            ...
            oleDbCommand.Parameters.AddWithValue("Barcode", manageItem.listView1.SelectedItems[0].SubItems[0].Text);
            oleDbCommand.Parameters.AddWithValue("OrderQuantity", manageItem.listView1.SelectedItems[0].SubItems[1].Text);
