...
namespace PosSystem
{
    internal class DisplayStock: SqlQueries
    {
        ...
        private void ShowSelectedData()
        {
            ...
            stock.comboBox1.SelectedIndex = stock.comboBox1.FindStringExact(stock.dataGridView1.SelectedRows[0].Cells[2].Value.ToString().Trim());

            stock.comboBox2.SelectedIndex = stock.comboBox2.FindStringExact(stock.dataGridView1.SelectedRows[0].Cells[3].Value.ToString().Trim());
            ...
            stock.labelBarcode.Text = "Barocde: " + stock.dataGridView1.SelectedRows[0].Cells[8].Value.ToString().Trim();
